    ...
    examples = [
        ...
        ExampleData(
            ...
            Dict(
                ...
                :dssp => Dict("310 helix" => 3, "bend" => 20, "turn" => 14, "beta bridge" => 0, "kappa helix" => 7, "pi helix" => 0, "beta strand" => 58, "alpha helix" => 118, "loop" => 67, "coil" => 0),
            )
        ),
        ExampleData(
        ...
        ExampleData(
            ...
            Dict(
                ...
                :dssp => Dict("310 helix" => 0, "bend" => 3, "turn" => 2, "beta bridge" => 2, "kappa helix" => 3, "pi helix" => 0, "beta strand" => 0, "alpha helix" => 0, "loop" => 5, "coil" => 0), 
            )
        ),
    ]
